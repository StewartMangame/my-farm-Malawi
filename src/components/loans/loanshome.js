    ...
    <div className="container mx-auto p-4 w-full bg-gray-100">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white p-4 rounded-lg shadow-md flex flex-row items-center">
          ...
          <div className="w-100 h-70">
            <img src="https://th.bing.com/th/id/OIP.tGTVnwrTjJ-3kyhWgKnRzgHaEo?w=299&h=186&c=7&r=0&o=5&pid=1.7" alt="Magulu Loans" className="w-full h-full object-cover rounded-md "/>
          </div>
        </div>
      </div>
    </div>
